...
results_uFE = pd.read_csv(str(Cwd / '02_Data/04_microFE/uFE_Data_Benjamin.csv'), skiprows=0)
...
results_merged['Min ECM Area / ' + 'mm\u00B2'] = results_uCT['Min ECM Area / mm^2']
results_merged['Coefficient of Variation / -'] = results_uCT['Coefficient of Variation / -']
results_merged['Mean Apparent Area / ' + 'mm\u00B2'] = results_uCT['Mean Apparent Area / mm^2']
results_merged['Mean ECM Area / ' + 'mm\u00B2'] = results_uCT['Mean ECM Area / mm^2']
results_merged['Min Equivalent Diameter / mm'] = results_uCT['Min Diameter / mm']
results_merged['Mean Apparent Diameter / mm'] = results_uCT['Mean Apparent Diameter / mm']
results_merged['Mean ECM Area Fraction / -'] = results_uCT['Mean Area Fraction / -']
results_merged['Min ECM Area Fraction / -'] = results_uCT['Min Area Fraction / -']
results_merged['Mineral to Matrix Ratio / -'] = results_raman['M2M_ratio_v2/a3_mean']
