...
b1 = peaks_index[-8]
b2 = peaks_index[-7]
minima = min(df['force_lc_filtered'][b1:b2])
minima_index = (df.loc[df['force_lc_filtered'] == minima]).index[0]
last_cycle_force = df['force_lc_filtered'][b1:minima_index]        # change this
last_cycle_disp = df['disp_ext'][b1:minima_index]                  # and this
