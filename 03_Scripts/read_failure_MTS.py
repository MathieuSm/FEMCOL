...
# plt.figure(figsize=(6, 4))
# plt.title(sample_ID)
plt.plot(df_393L['disp_ext'][:30413], df_393L['force_lc'][:30413], label='393L', linestyle='solid')
plt.plot(df_406L['disp_ext'][:26765], df_406L['force_lc'][:26765], label='406L', linestyle='dotted')
plt.plot(df_426R['disp_ext'][:41256], df_426R['force_lc'][:41256], label='426R', linestyle='dashed')
